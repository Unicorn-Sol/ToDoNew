...
//
//            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
//                val taskToUpdate = adapter.dataList[viewHolder.adapterPosition]
//                viewHolder.itemView.findNavController().navigate(R.id.actionListFragmentToUpdateFragment(taskToUpdate))
//            }
//
//        }
//        val itemTouchHelper = ItemTouchHelper(swipeToDeleteCallback)
